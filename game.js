...
if(canvas.getContext) {
    ...
    var game = {
        ...
        imgsrc: ["cool.png", "cat.png", "techno.png", "skin0.png", "skin1.png", "skin2.png",
         "speakerOn.png", "speakerOff.png", "blockUpper.png", "blockLower.png", "star.png"],
        images: [],
        highScore: 0,
        started: false,
        speed: 7,
    ...
    for(var i = 0; i < game.imgsrc.length; i++) {
        ...
        game.images[i].src = "img/" + game.imgsrc[i];
    }
